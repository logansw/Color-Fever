...
public class ScoreManager : MonoBehaviour
{
    ...
    public static int[,,] ScoreGridRows = {
        ...
        {   // 5
            ...
            {0, 0, 0, 0, 950, 950, 1200, 1450, 1650, 2400},
            {0, 0, 0, 0, 1150, 1150, 1550, 1800, 2000, 3000},
            {0, 0, 0, 0, 1500, 1500, 2100, 2400, 2700, 3800},
            {0, 0, 0, 0, 2000, 2000, 3000, 3400, 3800, 5000},
        },
        {   // 6
    ...
    public static int[,,] ScoreGridDiagonal = {
        {   // 3
            ...
            {600, 600, 600, 600, 650, 700, 800, 1200, 0, 0},
        },
        {   // 4
    ...
    public static int[,,] ScoreGridStarDiagonalUp = {
        // 3
        {
            ...
            {1600, 1600, 1600, 1600, 1600, 1800, 2300, 2600, 0, 0},
            {1800, 1800, 1800, 1800, 1800, 1900, 2100, 3000, 0, 0},
        },
        // 4
        {
    ...
    public static int[,,] ScoreGridStarDiagonalDown = {
        // 3
        {
            {1600, 1600, 1600, 1600, 1600, 1800, 2000, 2500, 0, 0},
            {1600, 1600, 1600, 1600, 1600, 1800, 2300, 2600, 0, 0},
            {1800, 1800, 1800, 1800, 1800, 1900, 2100, 3000, 0, 0},
        },
        // 4
